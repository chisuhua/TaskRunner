...
**关联 ADR (UsrLinuxEmu)**: —
**关联 Change**: —
**关联 Source**: [`docs/decision-frame-cuda-vulkan-runtime.md`](../../test-fixture/archive/2026-04-07-decision-frame-cuda-vulkan-runtime.md) §D1 (lines 21-58)
...
**本 TADR 作为历史决策记录保留**，让 v0.1 提案可追溯。如需查阅原始动机，见 [`docs/decision-frame-cuda-vulkan-runtime.md`](../../test-fixture/archive/2026-04-07-decision-frame-cuda-vulkan-runtime.md) §D1。
...
- **关联 Source**: [`docs/decision-frame-cuda-vulkan-runtime.md`](../../test-fixture/archive/2026-04-07-decision-frame-cuda-vulkan-runtime.md):21-58
- **关联设计提案**: [`docs/cuda-vulkan-runtime-architecture.md`](../../test-fixture/archive/2026-04-07-cuda-vulkan-runtime-architecture.md) §4.2 (方案 B 详细)
